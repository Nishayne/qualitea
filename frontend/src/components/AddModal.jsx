...
export default function AddModal({closeModal,setReload}) {
    ...
    const handleSubmit=async(e)=>{
      e.preventDefault()
      try{
        const response=await axios.post(`http://localhost:8000/product/create/${Auth._id}`,{title,desc:description,Image_url:imageUrl})
    ...
    return (
      <>
        <dialog id="addProdModal" className="modal">
